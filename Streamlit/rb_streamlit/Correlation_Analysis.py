...
st.write("""The result shows the t-statistic and p-value for a t-test performed on 
         various numerical features with respect to the "action_taken" target variable.""")
