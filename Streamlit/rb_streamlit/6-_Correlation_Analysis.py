...
st.write(""" - The action taken is notably influenced by financial factors, with a higher 
         correlation with total loan costs and a notable negative correlation with origination 
         charges.
         """)

st.write(""" - Demographic factors, specifically applicant and co-applicant age, also show a 
         moderate positive correlation with the action taken. """)

st.write(""" - The most significant influence comes from debt-to-income ratio, indicating 
         that higher debt relative to income is strongly associated a particular action taken.""")
